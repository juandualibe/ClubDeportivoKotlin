...
class AddedEditedSocioActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.added_edited_socio)
        ...
        // Al presionar Aceptar, regresar a SocioListActivity
        btnAceptar.setOnClickListener {
            val intent = Intent(this, SocioListActivity::class.java)
            startActivity(intent)
            finish() // Cierra AddedEditedSocioActivity
        }
    }
}