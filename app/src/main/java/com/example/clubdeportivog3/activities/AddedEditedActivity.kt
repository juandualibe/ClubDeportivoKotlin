...
class AddedEditedActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.added_edited_activity)
        ...
        // Al presionar Aceptar, regresar a ActividadesListActivity
        btnAceptar.setOnClickListener {
            val intent = Intent(this, ActividadesListActivity::class.java)
            startActivity(intent)
            finish() // Cierra AddedEditedActivity
        }
    }
}